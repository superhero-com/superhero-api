...
export const Searchable = (
  options?: SearchResolver | SearchableOptions,
): PropertyDecorator => {
  ...
  return (target: any, propertyKey: string | symbol) => {
    ...
    Reflect.defineMetadata(
      ...
      { resolver: resolver || null, description },
      target,
      propertyKey,
    );
    ...
    const existingFields =
      Reflect.getMetadata(SEARCHABLE_FIELDS_KEY, target) || new Map();
    existingFields.set(propertyKey, {
